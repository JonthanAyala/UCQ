...
insert into users values (0,'a','aa','AIGE041218HMSLRMA3','activo', 3,'20223tn.edu@utez.edu.mx','20223tn085','123456');
insert into users values (0,'a','aa','AIGE041218HMSLRMA3','activo', 3,'20223tn.edu@utez.edu.mx','20213tn085','123456');
insert into users values (0,'a','aa','AIGE041218HMSLRMA3','activo', 3,'20223tn.edu@utez.edu.mx','20233tn085','123456');
...
select * from users
group by type_user, enrollment order by type_user asc;
...
#________________________________________________________________________________________________________________________________________________________________________
#disparador before update__TA MAL______________________________________________________________________________________________________________________________________________
delimiter $$
...
#disparador after update____TA MAL____________________________________________________________________________________________________________________________________________
delimiter $$
CREATE TRIGGER update_status_trigger
...
$$
#________________________________________________________________________________________________________________________________________________________________________
#Disparador before delete_____Esta mal el if___________________________________________________________________________________________________________________________________________
DELIMITER $$
...
#Disparador after delete________borrar los datos del usuario en las demas tablas________________________________________________________________________________________________________________________________________
DELIMITER $$
CREATE TRIGGER deleted_user
...
/*vista de examenes__________________*/
create view vista_exams as 
select exams.id_exam as id_examen, exams.name_exam as nombre_examen,
...
BEGIN
    ...
    VALUES (new.exam_id, NEW.name_exam, NEW.code, NEW.start_time, NEW.fk_user);
END;$$
#________________________________________________________________________________________________________________________________________________________________________
...
delimiter $$
CREATE TRIGGER insert_exam_trigger
BEFORE INSERT ON exams
FOR EACH ROW
BEGIN
	declare count_name int(5);
    select count(name=new.name_exam) into count_name from users where fk_user=new.id_user;
    if count_name>0 then
	  SIGNAL SQLSTATE '45000'
      SET MESSAGE_TEXT = 'Nombre de Examen existente, agrega otro pa';
    end if;
END;$$
#________________________________________________________________________________________________________________________________________________________________________
...
BEGIN
	end_time>start_time
    SIGNAL SQLSTATE '45000'
      SET MESSAGE_TEXT = 'esta mal tu hora pa';
END;$$
#________________________________________________________________________________________________________________________________________________________________________
...
FOR EACH ROW
BEGIN
    DELETE FROM exams_questions WHERE id_exam = OLD.fk_exam inner join;
END;$$
#________________________________________________________________________________________________________________________________________________________________________
...
CREATE TABLE Students_exam (
  id_Student_exam INT NOT NULL auto_sumary,
  score INT(3) NULL,
...
/*vista de estudiantes tienen examen*/Vista para profesor
create view vista_Students_exam as 
select Students_exam.id_Student_exam as id_estudiante, Users.type_user as tipo_usuario ,Users.name as nombre, Users.surname as apellido,
...
CREATE TABLE Questions (
  ...
  create view vista_questions as 
  select questions.id_question as id_pregunta, questions.type_question as tipo_pregunta,
...
select questions_answer.id_Question_answer as id_pregunta_respuesta,  students_exam_answer.fk_student_exam as id_estudiante,
